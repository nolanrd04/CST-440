"""
TFLite Model Accuracy Evaluator
Author: CST-440 Team
Date: January 13, 2026

Evaluates the accuracy of trig_model_all.tflite by comparing predictions
against true trigonometric function values.

Usage:
    python evaluate_tflite_accuracy.py

    # With custom number of test samples
    python evaluate_tflite_accuracy.py --samples 1000

    # With different tolerance threshold
    python evaluate_tflite_accuracy.py --tolerance 0.01
"""
...
class TFLiteModelEvaluator:
    """Evaluates accuracy of TensorFlow Lite models."""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Evaluate TFLite model accuracy',
    ...
    parser.add_argument('--tolerance', '-t', type=float, default=0.05,
                       help='Error tolerance for accuracy calculation (default: 0.05)')
    ...
    # Create evaluator
    evaluator = TFLiteModelEvaluator(args.model)
