"""
Keras Model Accuracy Visualizer
Author: CST-440 Team
Date: January 13, 2026

Creates visualizations showing the accuracy of trig_model_all.keras
compared to true trigonometric function values.

Usage:
    python visualize_keras_accuracy.py

    # With custom number of samples
    python visualize_keras_accuracy.py --samples 500

    # Save to custom output file
    python visualize_keras_accuracy.py --output my_results.png
"""
...
class KerasModelVisualizer:
    """Visualizes accuracy of Keras models."""

    def __init__(self, model_path):
        """
        Initialize visualizer with Keras model.
    ...
    def visualize_accuracy(self, X_test, y_test, x_raw, func_labels, output_file='keras_accuracy_visualization.png'):
        ...
        plt.suptitle('Keras Model Accuracy Analysis', fontsize=16, fontweight='bold', y=0.995)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Visualize Keras model accuracy',
    ...
    parser.add_argument('--output', '-o', default='keras_accuracy_visualization.png',
                       help='Output file for visualization (default: keras_accuracy_visualization.png)')

    args = parser.parse_args()

    # Create visualizer
    visualizer = KerasModelVisualizer(args.model)
