"""
train_cnn_model.py - Train a 1D CNN model for keyword spotting and export to TFLite.

Handles:
- Loading preprocessed MFCC data (49 frames x 26 features)
- Building and training a 1D CNN classifier for 8 keyword classes
...
def build_model(input_shape, num_classes):
    ...
    Architecture: Conv1D(32,3) -> Conv1D(48,3) -> MaxPool -> Conv1D(48,3) -> GAP -> Dense(8)
    """
...
def main():
    print("=" * 60)
    print("Keyword Spotting - 1D CNN Model Training")
    print("=" * 60)
